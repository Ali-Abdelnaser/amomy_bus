...
class PrivacyPolicyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      appBar: AppAppBar(title: l10n.privacyPolicy, showBackButton: true),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text(
                isAr
                    ? 'سياسة خصوصية تطبيق عمومي باص'
                    : 'AMOMY Bus Privacy Policy',
              ...
              _PolicySection(
                title: isAr
                    ? '٢. بيانات الحجوزات والتذاكر'
                    : '2. Booking & Ticket Information',
                content: isAr
              ...
              _PolicySection(
                title: isAr
                    ? '٣. محفظة النقاط وإيصالات الشحن'
                    : '3. Points Wallet & Top-Up Proofs',
                content: isAr
              ...
              _PolicySection(
                title: isAr
                    ? '٤. تتبع الأتوبيسات والموقع الجغرافي'
                    : '4. Bus Tracking & Location Clarification',
                content: isAr
              ...
              _PolicySection(
                title: isAr
                    ? '٥. الإشعارات وبيانات الجهاز'
                    : '5. Push Notifications & Device Tokens',
                content: isAr
              ...
              _PolicySection(
                title: isAr
                    ? '٦. البنية التحتية والشركاء المعتمدون'
              ...
              _PolicySection(
                title: isAr
                    ? '٧. أمان البيانات وحقوق المستخدم'
                    : '7. Data Security & Your Rights',
                content: isAr
