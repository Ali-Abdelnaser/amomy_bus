...
class TermsAndConditionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      appBar: AppAppBar(title: l10n.termsAndConditions, showBackButton: true),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text(
                isAr
                    ? 'الشروط والأحكام لخدمة عمومي باص'
                    : 'AMOMY Bus Terms & Conditions',
              ...
              _TermsSection(
                title: isAr
                    ? '٣. حجز المقاعد وتوافرها المباشر'
                    : '3. Seat Reservations & Temporary Holds',
                content: isAr
              ...
              _TermsSection(
                title: isAr
                    ? '٤. محفظة النقاط والشحن والاسترداد'
                    : '4. Points Wallet, Top-Ups & Refunds',
                content: isAr
              ...
              _TermsSection(
                title: isAr
                    ? '٥. التذاكر الرقمية والصعود (QR / NFC)'
                    : '5. Digital Boarding Passes & Check-In',
                content: isAr
              ...
              _TermsSection(
                title: isAr
                    ? '٦. تتبع الأتوبيس والالتزام بالمواعيد'
                    : '6. Bus Tracking & Schedule Availability',
                content: isAr
              ...
              _TermsSection(
                title: isAr
                    ? '٧. سلوك الركاب وقواعد السلامة'
                    : '7. Passenger Conduct & Safety',
                content: isAr
              ...
              _TermsSection(
                title: isAr
                    ? '٨. الأعطال والظروف التشغيلية الطارئة'
                    : '8. Operational Disruptions & Changes',
                content: isAr
              ...
              _TermsSection(
                title: isAr
                    ...
                    : '9. Modifications & Support Inquiries',
                content: isAr
