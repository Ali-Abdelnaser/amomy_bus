...
class _BookingReviewCardState extends State<BookingReviewCard>
  ...
  Widget build(BuildContext context) {
    ...
    final fare = widget.routeStop?.farePoints ?? widget.trip.farePoints;
    final hasEnoughPoints = widget.userAvailablePoints >= fare;
    final balanceAfterBooking = (widget.userAvailablePoints - fare).clamp(
      0,
      double.infinity,
    );
    final deficitPoints = (fare - widget.userAvailablePoints).ceil();
    ...
    // 1. SURFACE A: JOURNEY CARD
    Widget journeyCard = Container(
        ...
        children: [
          ...
          Padding(
            ...
            child: _CompactRouteView(
              ...
              destinationLocality: widget.destinationRouteStop?.locality(
                locale,
              ),
              isAr: isAr,
            ),
