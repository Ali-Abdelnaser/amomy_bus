...
class AmomyFloatingAlert extends StatelessWidget {
  ...
  static void show(
    ...
    final fullMessage = (message != null && message.trim().isNotEmpty)
        ? '$title: $message'
        : title;

    switch (variant) {
      case AmomyAlertVariant.success:
        AppSnackBar.showSuccess(context, fullMessage);
      case AmomyAlertVariant.warning:
        AppSnackBar.showWarning(context, fullMessage);
      case AmomyAlertVariant.error:
        AppSnackBar.showError(context, fullMessage);
      case AmomyAlertVariant.info:
        AppSnackBar.showInfo(context, fullMessage);
    }
  }
