...
void main() {
  ...
  group('AppRouter Strict Profile Completion Guards', () {
    ...
    test(
      'Incomplete authenticated user attempting /home redirects to /complete-profile',
      () {
        final redirect = AppRouter.redirectLogic(
    ...
    test(
      'Incomplete authenticated user attempting /wallet redirects to /complete-profile',
      () {
        final redirect = AppRouter.redirectLogic(
          const Authenticated(user: incompleteUser),
          RoutePaths.wallet,
    ...
    test(
      'Incomplete authenticated user attempting booking redirects to /complete-profile',
      () {
        final redirect = AppRouter.redirectLogic(
          const Authenticated(user: incompleteUser),
          RoutePaths.bookTrip,
    ...
    test(
      'Incomplete authenticated user attempting /trips redirects to /complete-profile',
      () {
        final redirect = AppRouter.redirectLogic(
          const Authenticated(user: incompleteUser),
          RoutePaths.trips,
    ...
    test(
      'Incomplete authenticated user attempting /profile redirects to /complete-profile',
      () {
        final redirect = AppRouter.redirectLogic(
          const Authenticated(user: incompleteUser),
          RoutePaths.profile,
    ...
    test(
      'Incomplete user on /complete-profile is allowed (no redirect loop)',
      () {
        final redirect = AppRouter.redirectLogic(
          const Authenticated(user: incompleteUser),
    ...
    test(
      'Complete user with ProfileSaveFailure on /complete-profile in edit mode does NOT redirect to /login',
      () {
        final redirect = AppRouter.redirectLogic(
          ProfileSaveFailure(
            user: completeUser,
    ...
    test(
      'Incomplete user with ProfileSaveFailure on /complete-profile remains on /complete-profile (no /login redirect)',
      () {
        final redirect = AppRouter.redirectLogic(
    ...
    test(
      'Complete user with ProfileSaving on /complete-profile is allowed (no redirect)',
      () {
        final redirect = AppRouter.redirectLogic(
    ...
    test(
      'AuthFailureState while on /complete-profile does NOT redirect to /login',
      () {
        final redirect = AppRouter.redirectLogic(
